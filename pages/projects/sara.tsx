        ...
        <section className="px-5 md:px-0">
            ...
            >
                ...
                <section className="mx-auto my-5 md:my-10 md:w-3/5 lg:w-1/2">
                    ...
                    <ul>
                        <li>NextJS {t("sara.techStack.nextjs")}</li>
                        <li>TailwindCSS {t("sara.techStack.tailwind")} </li>
                        <li>Contentful {t("sara.techStack.contentful")}</li>
                        <li>GraphQL {t("sara.techStack.graphql")}</li>
                        <li>Formspree {t("sara.techStack.formspree")}</li>
                        <li>Vercel {t("sara.techStack.vercel")}</li>
                    </ul>
                </section>
                <section className="mx-auto my-5 md:my-10 md:w-3/5 lg:w-1/2">
                    <p>
